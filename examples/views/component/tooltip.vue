<template>
    <div class="tooltip-page article">
        ...
        <panel>
            <div slot="template">
                <div class="panel-case">
                    <Wb-button v-tooltip="option13">html字符串</Wb-button>
                </div>
                <div class="panel-header">
                    <span>html字符串</span>
                </div>
        ...
        <panel>
            <div slot="template">
                <div class="panel-case">
                    <Wb-button v-tooltip="option14">component模版</Wb-button>
                </div>
                <div class="panel-header">
                    <span>自定义组件</span>
                </div>
        ...
        <section>
            <table>
                ...
                <tr>
                    ...
                    <td style="text-align:left">提示的内容，是html结构的字符串</td>
                    <td style="text-align:left">String</td>
                    <td style="text-align:left">null</td>
                </tr>
                <tr>
                    <td style="text-align:left">component</td>
                    <td style="text-align:left">提示的内容，是一个vue组件</td>
                    <td style="text-align:left">Object</td>
                    <td style="text-align:left">null</td>
                </tr>
                <tr>
                    <td style="text-align:left">direction</td>
                    <td style="text-align:left">提示的朝向，相对于dom来说，默认是朝下。可选值有“left”、“right”、“top”、“bottom”</td>
                    <td style="text-align:left">String</td>
                    <td style="text-align:left">bottom</td>
                </tr>
                <tr>
                    <td style="text-align:left">align</td>
                    <td style="text-align:left">提示的文字相对于dom的位置，默认是center。可选值有“top”、“bottom”、“center”、“right”、“left”</td>
                    <td style="text-align:left">String</td>
                    <td style="text-align:left">center</td>
                </tr>
                <tr>
                    <td style="text-align:left">confirm</td>
                    <td style="text-align:left">是否是询问模式</td>
                    <td style="text-align:left">Boolean</td>
                    <td style="text-align:left">false</td>
                </tr>
                <tr>
                    <td style="text-align:left">onOk</td>
                    <td style="text-align:left">点击确认触发</td>
                    <td style="text-align:left">Function</td>
                    <td style="text-align:left">null</td>
                </tr>
                <tr>
                    <td style="text-align:left">onCancel</td>
                    <td style="text-align:left">点击取消触发</td>
                    <td style="text-align:left">Function</td>
                    <td style="text-align:left">null</td>
                </tr>
                </tbody>
