<template>
    <div class="toast-page article">
        ...
        <ul>
            <li>this.$Toast(message, [option])</li>
            <li>this.$Toast.success(message, [option])</li>
            <li>this.$Toast.error(message, [option])</li>
            <li>this.$Toast.warn(message, [option])</li>
        </ul>
        <section>
            <table>
                <thead>
                ...
                <tr>
                    ...
                    <td style="text-align:left">提示的区域，可选值有'top','center'</td>
                    <td style="text-align:left">String</td>
...
<script>
    ...
    import markdown4 from './md/toast4.md'
    export default {
        components: {
