...
export default {
    ...
    methods: {
        ...
        setParent(node) {
            ...
            if (parent) {
                parent.checked = parent.children.some(obj => {
                    return obj.checked;
                });
                var childrenCheckedStatus;
                if (
                    parent.children.every(son => {
        ...
        recursion(collection, node, parent) {
            let obj = Object.assign({}, node, { children: [] });
        ...
        removeNode(node) {
            if (node.parent) {
                ...
                if (index != -1) {
                    ...
                    let _node = parent.children.length > 0 ? parent.children[0] : parent;
